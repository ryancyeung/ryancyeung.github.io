...
Optional, but strongly recommended: Up-to-date version of R ([https://cloud.r-project.org/](https://cloud.r-project.org/)) and RStudio ([https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/))

<iframe src="https://ryancyeung.github.io/assets/html/r_workshop.html" frameborder=0 ALLOWTRANSPARENCY="true" style="width:100%;height:500px">
